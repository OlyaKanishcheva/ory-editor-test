...
var createPlugin = function (settings) {
    if (settings === void 0) { settings = settings_1.defaultSettings; }
    var WrappedComponent = function (props) { return (React.createElement(index_1.default, __assign({}, props, settings))); };
    return {
        Component: WrappedComponent,
        name: 'ory/editor/core/content/video',
        version: '0.0.1',
        IconComponent: React.createElement(PlayArrow_1.default, null),
        text: 'Video',
